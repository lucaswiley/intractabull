      ...
      <div className="flex flex-col md:flex-row md:gap-12 items-start">
        ...
        <div className="flex-1 space-y-5">
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            I am the cofounder and CTO of <a className="text-blue-400 hover:text-blue-300 transition-colors font-medium underline" href="https://scoutcities.com" target="_blank" rel="noopener noreferrer">ScoutCities</a>, where we are building site selection technology to advance the American industrial base. We use AI to make it easy for industrial businesses to find the perfect location for their next facility. What has historically been a high risk process with countless months of working with consultants, is now a software interface that makes the process of finding a location faster, easier, and more reliable.
          </p>
          <p className="text-base sm:text-lg leading-relaxed">
            Before ScoutCities, I was the lead data and machine learning engineer at <a className="text-blue-400 hover:text-blue-300 transition-colors font-medium underline" href="https://tremendous.com" target="_blank" rel="noopener noreferrer">Tremendous</a>. Before Tremendous, I was one of the first data engineers at <a className="text-blue-400 hover:text-blue-300 transition-colors font-medium underline" href="https://flexport.com" target="_blank" rel="noopener noreferrer">Flexport</a>.
          </p>
          <p className="text-base sm:text-lg leading-relaxed">
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            I spend my free time in the ocean and mountains. These activities teach me humility and appreciation for the universe.
          </p>
